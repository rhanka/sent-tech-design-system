...
> Départ : **74,8 %** (109 ≠) → 1ère passe **84,0 %** (69 ≠) → passe F1+F2 **87,3 %** (55 ≠) → passe F3+F4+F6 (boîte-champ DSFR) **89,4 %** (46 ≠) → passe F5+F9 (line-height + padding sur Button/Select/Link/Card) **92,8 %** (31 ≠). **Cible : 100 % de fermeture**
