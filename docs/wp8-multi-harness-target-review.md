...
1. **Moteur maison** `@sentropic/design-system-impeccable` (`packages/impeccable`) pour l’analyse visuelle.
...
2. **Harness unifié**
   - Orchestrateur unique : `tools/skills/sent-tech-impeccable/scripts/audit.mjs`.
...
1. Les fichiers suivants existent :
   - `tools/skills/sent-tech-impeccable/SKILL.md`
   - `tools/skills/sent-tech-impeccable/scripts/audit.mjs`
   - `tools/skills/sent-tech-impeccable/reference/README.md`
   - `docs/wp8-multi-harness-target-review.md`
   - `docs/ds-audit-consolidated-v2.md`
2. Vérification locale :
   ```bash
   node tools/skills/sent-tech-impeccable/scripts/audit.mjs http://localhost:4173
   ```
