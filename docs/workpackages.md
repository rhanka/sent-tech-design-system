...
| WP10 | Theming via moteur design | 🟡 | 76% | DSFR/Carbon et Airbus public-ready sur `main`, comparatif local opérationnel, garde-fous tests phase2 Airbus ajoutés (`airbusTheme`, focus/hover partagés). | Rollout Phase 2 des composants hors pilotes + gouvernance de publication client. | Décision de distribution publique du thème Airbus. |
