...
svelte/react/vue (≈118), pas pour angular (76 après les lots 1 à 4). La parité angular est le
...
- **P1 — Parité angular (prérequis, hors lot D).** `dataviz-angular`
  n'exporte que 76/119 composants (lots 1 à 4 livrés ; 43 restants, patron de portage
  dans `packages/dataviz-angular/PATTERN.md`). Sans la suite, aucune page DS ne
  peut satisfaire la règle de parité des frameworks au-delà de ces 76. Recommandé
