// Hydratation de xyflow rendu par svelte/server (sized+handles, voir o3/ssr.mjs).
...
try {
  ...
  hydrate(XyflowScene, { target: host, props: { view, sized: true, handles: true, oninit: () => { tInit = performance.now(); } } });
