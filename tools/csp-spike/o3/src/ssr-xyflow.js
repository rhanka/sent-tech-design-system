// Hydratation de xyflow rendu par svelte/server (sized=false, voir o3/ssr.mjs).
...
try {
  ...
  hydrate(XyflowScene, { target: host, props: { view, sized: false, oninit: () => { tInit = performance.now(); } } });
