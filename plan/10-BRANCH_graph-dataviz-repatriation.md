...
- [ ] **M2 — Fondations**
  ...
  - [ ] `GD-M2-PARITY` et `GD-M2-THEMES` : quatre frameworks, a11y/IME/SSR et géométrie/token communes. Retard mesuré : `dataviz-angular` expose 57 composants contre 118 en Svelte, 118 en React et 117 en Vue (union des trois : 119) ; lots 1 à 3 livrés avec le patron de portage (`packages/dataviz-angular/PATTERN.md`) et le générateur `tools/dataviz-angular-port`, 62 adaptateurs restants.
