...
export class ChatComposer {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.17", type: ChatComposer, isStandalone: true, selector: "st-chat-composer", inputs: { value: "value", placeholder: "placeholder", submitLabel: "submitLabel", classInput: ["class", "classInput"] }, ngImport: i0, template: `
