...
export class AnomalySwimLaneChart {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.17", type: AnomalySwimLaneChart, isStandalone: true, selector: "st-anomaly-swim-lane-chart", inputs: { data: "data", max: "max", label: "label", width: "width", height: "height", size: "size", classInput: ["class", "classInput"] }, ngImport: i0, template: `
