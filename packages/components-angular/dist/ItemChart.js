...
export function seatCount(value) {
    if (!Number.isFinite(value) || value < 0)
        return 0;
    return Math.round(value);
}
export function buildSeats(counts, width, height) {
...
export class ItemChart {
    ...
    get layout() {
        return buildSeats(this.groups.map((g) => g.count), this.widthValue, this.heightValue);
    }
    get seats() {
    ...
    seatClass(seat) {
        ...
        return classNames("st-itemChart__seat", `st-itemChart__seat--${seat.tone}`, dim && "st-itemChart__seat--dim");
    }
    legendItemClass(index) {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.17", type: ItemChart, isStandalone: true, selector: "st-item-chart", inputs: { data: "data", width: "width", height: "height", label: "label", classInput: ["class", "classInput"] }, ngImport: i0, template: `
