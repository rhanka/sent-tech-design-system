...
export class Search {
    ...
    get hostClass() {
        return classNames("st-field", this.fluid ? "st-search--fluid" : undefined, this.classInput);
    }
    get groupClass() {
