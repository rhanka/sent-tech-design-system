...
export class Avatar {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.17", type: Avatar, isStandalone: true, selector: "st-avatar", inputs: { name: "name", src: "src", alt: "alt", size: "size", shape: "shape", tone: "tone", classInput: ["class", "classInput"] }, ngImport: i0, template: `
