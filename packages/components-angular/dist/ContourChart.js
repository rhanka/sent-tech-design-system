...
export class ContourChart {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.17", type: ContourChart, isStandalone: true, selector: "st-contour-chart", inputs: { data: "data", levels: "levels", label: "label", width: "width", height: "height", size: "size", classInput: ["class", "classInput"] }, ngImport: i0, template: `
