...
export class BulletChart {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.17", type: BulletChart, isStandalone: true, selector: "st-bullet-chart", inputs: { data: "data", label: "label", orientation: "orientation", width: "width", height: "height", classInput: ["class", "classInput"] }, ngImport: i0, template: `
