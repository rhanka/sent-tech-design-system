...
import { buildSmoothPath, formatTick, isNumeric, niceTicks, scaleLinear, } from "./chartScale.js";
...
export class AreaSplineRangeChart {
    ...
    gradientId = `st-areasplinerangechart-gradient-${Math.random().toString(36).substring(2, 9)}`;
    normalize(d) {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.17", type: AreaSplineRangeChart, isStandalone: true, selector: "st-area-spline-range-chart", inputs: { data: "data", width: "width", height: "height", tone: "tone", label: "label", classInput: ["class", "classInput"] }, ngImport: i0, template: `
