...
export class ColumnRangeChart {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.17", type: ColumnRangeChart, isStandalone: true, selector: "st-column-range-chart", inputs: { data: "data", width: "width", height: "height", orientation: "orientation", label: "label", domain: "domain", classInput: ["class", "classInput"] }, ngImport: i0, template: `
