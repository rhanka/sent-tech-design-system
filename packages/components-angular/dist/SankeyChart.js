...
export class SankeyChart {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.17", type: SankeyChart, isStandalone: true, selector: "st-sankey-chart", inputs: { nodes: "nodes", links: "links", width: "width", height: "height", label: "label", classInput: ["class", "classInput"] }, ngImport: i0, template: `
