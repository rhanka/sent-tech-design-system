...
export class SunburstChart {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.17", type: SunburstChart, isStandalone: true, selector: "st-sunburst-chart", inputs: { data: "data", width: "width", height: "height", legend: "legend", label: "label", classInput: ["class", "classInput"] }, ngImport: i0, template: `
