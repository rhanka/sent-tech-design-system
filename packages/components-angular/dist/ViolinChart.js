...
export class ViolinChart {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.17", type: ViolinChart, isStandalone: true, selector: "st-violin-chart", inputs: { data: "data", bins: "bins", quartiles: "quartiles", width: "width", height: "height", label: "label", classInput: ["class", "classInput"] }, ngImport: i0, template: `
