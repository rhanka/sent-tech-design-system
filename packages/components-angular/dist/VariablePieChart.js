...
function computeSectors(data, width, height) {
    const cx = width / 2;
    const cy = height / 2;
...
export class VariablePieChart {
    static stComponentName = "VariablePieChart";
    componentName = "VariablePieChart";
    hoveredIndex = null;
    data = [];
    width;
    height;
    ...
    sectorClass(i) {
        ...
        return classNames("st-variablePieChart__sector", sector ? `st-variablePieChart__sector--${sector.tone}` : "", this.hoveredIndex !== null && this.hoveredIndex !== i && "st-variablePieChart__sector--dim");
    }
    contrastText(tone) {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: VariablePieChart, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.17", type: VariablePieChart, isStandalone: true, selector: "st-variable-pie-chart", inputs: { data: "data", width: "width", height: "height", label: "label", classInput: ["class", "classInput"] }, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: VariablePieChart, decorators: [{
            type: Component,
            args: [{
