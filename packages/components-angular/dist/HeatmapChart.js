...
export class HeatmapChart {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.17", type: HeatmapChart, isStandalone: true, selector: "st-heatmap-chart", inputs: { data: "data", width: "width", height: "height", legend: "legend", label: "label", classInput: ["class", "classInput"] }, ngImport: i0, template: `
