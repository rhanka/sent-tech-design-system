...
const BOX_MARGIN = { top: 16, right: 20, bottom: 38, left: 48 };
export class BoxPlotChart {
    static stComponentName = "BoxPlotChart";
    componentName = "BoxPlotChart";
    MARGIN_LEFT = BOX_MARGIN.left;
    MARGIN_RIGHT = BOX_MARGIN.right;
    MARGIN_TOP = BOX_MARGIN.top;
    MARGIN_BOTTOM = BOX_MARGIN.bottom;
    hoveredIndex = null;
    data = [];
    width;
    height;
    ...
    get plots() {
        ...
        return this.data.map((datum, index) => {
            ...
            const y = (value) => BOX_MARGIN.top + this.scaleLinear(value, dMin, dMax, this.plotHeight, 0);
    ...
    boxClass(plot, i) {
        return classNames("st-boxPlotChart__box", `st-boxPlotChart__box--${plot.tone}`, this.hoveredIndex !== null && this.hoveredIndex !== i && "st-boxPlotChart__box--dim");
    }
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: BoxPlotChart, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.17", type: BoxPlotChart, isStandalone: true, selector: "st-box-plot-chart", inputs: { data: "data", width: "width", height: "height", label: "label", classInput: ["class", "classInput"] }, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: BoxPlotChart, decorators: [{
            type: Component,
            args: [{
