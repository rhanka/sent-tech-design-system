...
function candleScaleLinear(v, d0, d1, r0, r1) {
    if (d1 === d0)
        return r0;
    return r0 + ((v - d0) * (r1 - r0)) / (d1 - d0);
}
function candleNiceTicks(min, max, target = 5) {
...
export class CandlestickChart {
    ...
    bodyClass(c) {
        ...
        return classNames("st-candlestickChart__body", `st-candlestickChart__body--${c.bullish ? "up" : "down"}`, dim && "st-candlestickChart__body--dim");
    }
    polygonPointsFor(a) {
