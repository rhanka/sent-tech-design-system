 ...
 */
export type CellDecorationIconNode = Array<[string, Record<string, string | number>]>;

export const cellDecorationIconNodes: Record<string, CellDecorationIconNode> = {
  "trending-up": [
    ["path", { d: "M16 7h6v6" }],
...
/** Nœuds lucide pour l'icône, ou `null` si le nom est inconnu (ignoré proprement). */
export function cellDecorationIcon(icon: string | undefined): CellDecorationIconNode | null {
