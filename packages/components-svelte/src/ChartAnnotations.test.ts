...
import { annotationDataListItems, resolveAnnotations } from "./lib/chartAnnotations.js";
...
describe("LineChart annotations", () => {
  ...
  it("renders the 5 kinds and appends a11y items", () => {
    ...
    const { container } = render(LineChart, { props: { label: "Ann", data: lineData, annotations } });
  ...
  it("draws regions BEHIND and other annotations ABOVE the series", () => {
    ...
    const { container } = render(LineChart, { props: { label: "Order", data: lineData, annotations } });
