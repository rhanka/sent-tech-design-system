...
<script lang="ts">
  import { CandlestickChart as DsCandlestickChart } from '@sentropic/design-system-svelte';
  import type { CandlestickChartDatum } from '@sentropic/design-system-svelte';
