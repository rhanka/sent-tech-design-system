...
<script lang="ts">
  import { AreaSplineRangeChart as DsAreaSplineRangeChart } from '@sentropic/design-system-svelte';
  import type { AreaSplineRangeChartDatum } from '@sentropic/design-system-svelte';
