...
describe('relativeRangeToSpec (vue)', () => {
...
describe('RelativeDateFilter (vue)', () => {
  it('renders a labelled select and does not filter for the default "all" preset', () => {
    ...
    const w = mount(RelativeDateFilter, { props: { store, dimension: 'date', label: 'Période', now: NOW } });
