...
export const GeoChart = defineComponent({
  name: "GeoChart",
  props: {
    layers: { type: Array as () => GeoChartLayer[], required: true },
    width: { type: Number, default: 520 },
    height: { type: Number, default: 320 },
    projection: { type: String as () => GeoChartProjection, default: "equirectangular" },
    bounds: { type: Object as () => GeoChartBounds, default: undefined },
