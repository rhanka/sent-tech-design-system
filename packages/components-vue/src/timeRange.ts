...
// unit-testable without mounting Vue at all. Ported verbatim from the Svelte
// reference (packages/components-svelte/src/lib/timeRange.ts) — behavior must
// stay identical across frameworks.
