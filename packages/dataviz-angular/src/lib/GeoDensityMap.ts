 ...
 */
@Component({
  selector: 'st-dataviz-geo-density-map',
  standalone: true,
  imports: [DsGeoChart],
...
export class GeoDensityMap implements OnInit, OnChanges, OnDestroy {
  static readonly stComponentName = 'GeoDensityMap';
  ...
  get store(): DashboardStore {
    if (!this.signals) {
      throw new Error('GeoDensityMap: store is required.');
    }
  ...
  private recompute(): void {
    this.classValue = mapClass('st-geoDensityMap', this.classInput);
