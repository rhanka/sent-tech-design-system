...
import { TreegraphChart as DsTreegraphChart, type TreegraphChartNode } from '@sentropic/design-system-angular';
...
/**
 * State wiring for a DS Angular TreegraphChart.
 * Generated from tools/dataviz-angular-port/descriptors.json — see that
 * directory's README before editing this file by hand.
 */
@Component({
  selector: 'st-dataviz-treegraph-chart',
  standalone: true,
  imports: [DsTreegraphChart],
...
export class TreegraphChart implements OnInit, OnChanges, OnDestroy {
  ...
  get store(): DashboardStore {
    if (!this.signals) {
      throw new Error('TreegraphChart: store is required.');
    }
