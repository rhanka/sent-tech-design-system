 ...
 */
@Component({
  selector: 'st-dataviz-geo-cluster-map',
  standalone: true,
  imports: [DsGeoChart],
...
export class GeoClusterMap implements OnInit, OnChanges, OnDestroy {
  static readonly stComponentName = 'GeoClusterMap';
  ...
  get store(): DashboardStore {
    if (!this.signals) {
      throw new Error('GeoClusterMap: store is required.');
    }
  ...
  private recompute(): void {
    this.classValue = mapClass('st-geoClusterMap', this.classInput);
