 ...
 */
@Component({
  selector: 'st-dataviz-geo-point-map',
  standalone: true,
  imports: [DsGeoChart],
...
export class GeoPointMap implements OnInit, OnChanges, OnDestroy {
  static readonly stComponentName = 'GeoPointMap';
  ...
  get store(): DashboardStore {
    if (!this.signals) {
      throw new Error('GeoPointMap: store is required.');
    }
  ...
  private recompute(): void {
    this.classValue = mapClass('st-geoPointMap', this.classInput);
