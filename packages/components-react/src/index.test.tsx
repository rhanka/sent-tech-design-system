...
const componentCases: Array<{ name: string; element: React.ReactElement; text: string }> = [
  ...
  { name: "DonutChart", element: <DonutChart data={chartData} label="Donut label" />, text: "Donut label" },
  ...
  { name: "ScatterPlot", element: <ScatterPlot data={[{ x: 1, y: 2, label: "Point one" }]} label="Scatter label" />, text: "Scatter label" },
