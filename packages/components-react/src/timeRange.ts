...
// unit-testable without mounting React at all. Ported verbatim from the
// Svelte reference (packages/components-svelte/src/lib/timeRange.ts) —
// behavior must stay identical across frameworks.
