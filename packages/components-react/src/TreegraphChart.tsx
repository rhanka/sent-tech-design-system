...
export type TreegraphChartProps = Omit<React.HTMLAttributes<HTMLDivElement>, "className"> & {
...
export function TreegraphChart({
  ...
  const { nodes, links, rowH } = buildLayout(data, width, height);
  ...
  return (
    <div {...rest} className={classNames("st-treegraphChart", className)}>
      <div className="st-treegraphChart__visual" role="img" aria-label={label}>
        <svg
        ...
        >
          {links.map((link) => {
            ...
            return (
              <path
                key={link.id}
                className="st-treegraphChart__link"
          ...
          {nodes.map((node) => {
            ...
            return (
              <g key={node.id} className="st-treegraphChart__node">
                <circle
                ...
                />
                <text
                  className="st-treegraphChart__label"
