...
// ── Thèmes valides ────────────────────────────────────────────────────────────
export type ThemeId = "sent-tech" | "dsfr" | "carbon" | "airbus" | "canada" | "quebec" | "ssense";
export const VALID_THEME_IDS: readonly ThemeId[] = ["sent-tech", "dsfr", "carbon", "airbus", "canada", "quebec", "ssense"];
