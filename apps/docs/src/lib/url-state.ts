...
// ── Thèmes valides ────────────────────────────────────────────────────────────
export type ThemeId = "sent-tech" | "dsfr" | "carbon" | "airbus" | "canada" | "quebec" | "ssense" | "lightspeed" | "desjardins" | "national-bank" | "cirque-du-soleil" | "ubisoft" | "bombardier" | "cae" | "saq" | "cgi" | "stm" | "nuvei" | "coveo" | "circle-k" | "aldo" | "brp";
export const VALID_THEME_IDS: readonly ThemeId[] = ["sent-tech", "dsfr", "carbon", "airbus", "canada", "quebec", "ssense", "lightspeed", "desjardins", "national-bank", "cirque-du-soleil", "ubisoft", "bombardier", "cae", "saq", "cgi", "stm", "nuvei", "coveo", "circle-k", "aldo", "brp"];
