...
<div class="docs-page">
  ...
  <TriRender nodes={getExample("autosave")?.nodes ?? []} label={fr ? "Aperçu live" : "Live preview"} />

  <section class="docs-section">
    <h2>{t(locale.value, "examplesTitle")}</h2>
    <TriRender nodes={savedDemo} label="status=&quot;saved&quot;" />
    <TriRender nodes={savingDemo} label="status=&quot;saving&quot;" />
    <TriRender nodes={errorDemo} label="status=&quot;error&quot;" />
  </section>
