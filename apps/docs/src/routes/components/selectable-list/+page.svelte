...
<div class="docs-page">
  ...
  <TriRender nodes={getExample("selectable-list")?.nodes ?? []} label={fr ? "Aperçu live" : "Live preview"} />

  <section class="docs-section">
    <h2>{t(locale.value, "examplesTitle")}</h2>
    <TriRender nodes={singleDemo} label={fr ? "Sélection unique" : "Single select"} />
    <TriRender nodes={multipleDemo} label="multiple" />
  </section>
