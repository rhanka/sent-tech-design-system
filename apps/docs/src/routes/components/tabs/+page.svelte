...
<div class="docs-page">
  ...
  <TriRender nodes={getExample("tabs")?.nodes ?? []} label="Aperçu live" />
  ...
  <section class="docs-section">
    ...
    <TriRender nodes={interactiveDemo} label={fr("Sections du projet", "Project sections")} />
  ...
  <section class="docs-section">
    ...
    <TriRender nodes={initialDemo} label={fr("Avec onglet initial", "With initial tab")} />
  </section>
