...
<div class="docs-page">
  ...
  <TriRender nodes={getExample("time-picker")?.nodes ?? []} label={fr ? "Aperçu live" : "Live preview"} />

  <section class="docs-section">
    <h2>{t(locale.value, "examplesTitle")}</h2>
    <TriRender nodes={baseDemo} label={fr ? "Pas de 15 min" : "15-min step"} />
    <TriRender nodes={boundedDemo} label="min / max" />
    <TriRender nodes={twelveDemo} label="format=&quot;12&quot;" />
  </section>
