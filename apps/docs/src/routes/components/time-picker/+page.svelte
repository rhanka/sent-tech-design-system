...
<div class="docs-page">
  ...
  <FrameworkPreview example="time-picker" title={fr ? "Aperçu live" : "Live preview"} />

  <section class="docs-section">
    <h2>{t(locale.value, "examplesTitle")}</h2>
    <FrameworkDemo nodes={baseDemo} label={fr ? "Pas de 15 min" : "15-min step"} />
    <FrameworkDemo nodes={boundedDemo} label="min / max" />
    <FrameworkDemo nodes={twelveDemo} label="format=&quot;12&quot;" />
  </section>
