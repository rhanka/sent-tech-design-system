...
<div class="docs-page">
  <section class="docs-hero">
    ...
    <p>
      {fr
        ? "Note par étoiles, contrôlée par value. Cliquable et navigable au clavier, ou en lecture seule ; option de demi-étoiles."
        : "Star rating controlled by value. Clickable and keyboard-navigable, or read-only; optional half-star precision."}
    </p>
  </section>

  <FrameworkPreview example="rating" title={fr ? "Aperçu live" : "Live preview"} />

  <section class="docs-section">
    <h2>{t(locale.value, "examplesTitle")}</h2>
    <FrameworkDemo nodes={interactiveDemo} label={fr ? "Interactif" : "Interactive"} />
    <FrameworkDemo nodes={halfDemo} label="allowHalf" />
    <FrameworkDemo nodes={readonlyDemo} label="readonly" />
  </section>
