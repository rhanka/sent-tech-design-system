...
<div class="docs-page">
  ...
  <TriRender nodes={getExample("menutriggerbutton")?.nodes ?? []} label="Aperçu live" />


  <section class="docs-section">
    <h2>{t(locale.value, "examplesTitle")}</h2>
    <TriRender nodes={defaultDemo} label="Default chevron icon" />
    <TriRender nodes={customIconDemo} label="Custom icon" />
