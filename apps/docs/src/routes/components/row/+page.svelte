...
<div class="docs-page">
  ...
  <FrameworkPreview example="row" title={fr ? "Aperçu live" : "Live preview"} />

  <section class="docs-section">
    <h2>{t(locale.value, "examplesTitle")}</h2>
    <FrameworkDemo nodes={gutterDemo} label={fr ? "Deux colonnes 6/6, gutter=6" : "Two 6/6 columns, gutter=6"} />
    <FrameworkDemo nodes={mixedDemo} label={fr ? "Quatre colonnes 3/3/3/3" : "Four 3/3/3/3 columns"} />
  </section>
