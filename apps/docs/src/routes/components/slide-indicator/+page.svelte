...
<div class="docs-page">
  ...
  <TriRender nodes={getExample("slide-indicator")?.nodes ?? []} label={fr ? "Aperçu live" : "Live preview"} />

  <section class="docs-section">
    <h2>{t(locale.value, "examplesTitle")}</h2>
    <TriRender nodes={dotsDemo} label={fr ? "Points" : "Dots"} />
    <TriRender nodes={barsDemo} label="variant=&quot;bars&quot;" />
    <TriRender nodes={sizeDemo} label="size=&quot;lg&quot;" />
  </section>
