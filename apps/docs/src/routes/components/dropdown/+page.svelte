...
<div class="docs-page">
  ...
  <TriRender nodes={getExample("dropdown")?.nodes ?? []} label="Aperçu live" />
  ...
  <section class="docs-section">
    ...
    <TriRender nodes={initialDemo} label={fr("Produit", "Product")} />
  ...
  <section class="docs-section">
    ...
    <TriRender nodes={placeholderDemo} label={fr("Forfait", "Plan")} />
