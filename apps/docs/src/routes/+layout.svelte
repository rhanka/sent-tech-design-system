<script lang="ts">
  ...
  import ChromeLvmh from "$lib/chrome/ChromeLvmh.svelte";
  import ChromeOrange from "$lib/chrome/ChromeOrange.svelte";
  import ChromeBnpParibas from "$lib/chrome/ChromeBnpParibas.svelte";
  import ChromeAxa from "$lib/chrome/ChromeAxa.svelte";
  import ChromeTotalenergies from "$lib/chrome/ChromeTotalenergies.svelte";
  import ChromeLoreal from "$lib/chrome/ChromeLoreal.svelte";
  import ChromeSanofi from "$lib/chrome/ChromeSanofi.svelte";
  import ChromeDanone from "$lib/chrome/ChromeDanone.svelte";
  import ChromeHermes from "$lib/chrome/ChromeHermes.svelte";
  import ChromeKering from "$lib/chrome/ChromeKering.svelte";
  import ChromeAccor from "$lib/chrome/ChromeAccor.svelte";
  import ChromeAirLiquide from "$lib/chrome/ChromeAirLiquide.svelte";
  import ChromeSchneiderElectric from "$lib/chrome/ChromeSchneiderElectric.svelte";
  import ChromeEngie from "$lib/chrome/ChromeEngie.svelte";
  import ChromeEdf from "$lib/chrome/ChromeEdf.svelte";
  import ChromeVinci from "$lib/chrome/ChromeVinci.svelte";
  import ChromeBouygues from "$lib/chrome/ChromeBouygues.svelte";
  import ChromeVeolia from "$lib/chrome/ChromeVeolia.svelte";
  import ChromePublicis from "$lib/chrome/ChromePublicis.svelte";
  import ChromeRenault from "$lib/chrome/ChromeRenault.svelte";
  import ChromePernodRicard from "$lib/chrome/ChromePernodRicard.svelte";
  import ChromeCreditAgricole from "$lib/chrome/ChromeCreditAgricole.svelte";
  import ChromeSocieteGenerale from "$lib/chrome/ChromeSocieteGenerale.svelte";
  import ChromeEdenred from "$lib/chrome/ChromeEdenred.svelte";
  import ChromeWorldline from "$lib/chrome/ChromeWorldline.svelte";
  import ChromeSaintGobain from "$lib/chrome/ChromeSaintGobain.svelte";
  import ChromeDassaultSystemes from "$lib/chrome/ChromeDassaultSystemes.svelte";
  import ChromeThales from "$lib/chrome/ChromeThales.svelte";
  import ChromeSafran from "$lib/chrome/ChromeSafran.svelte";
  import ChromeCapgemini from "$lib/chrome/ChromeCapgemini.svelte";
  import ChromeAnthropic from "$lib/chrome/ChromeAnthropic.svelte";
  import ChromeOpenai from "$lib/chrome/ChromeOpenai.svelte";
  import ChromeGemini from "$lib/chrome/ChromeGemini.svelte";
  import ChromeGithub from "$lib/chrome/ChromeGithub.svelte";
  import ChromeMistral from "$lib/chrome/ChromeMistral.svelte";
  import ChromePerplexity from "$lib/chrome/ChromePerplexity.svelte";
  import ChromeCopilot from "$lib/chrome/ChromeCopilot.svelte";
  import ChromePalantir from "$lib/chrome/ChromePalantir.svelte";
  import ChromeNousHermes from "$lib/chrome/ChromeNousHermes.svelte";
  import ChromeAmazon from "$lib/chrome/ChromeAmazon.svelte";
  import ChromeVercel from "$lib/chrome/ChromeVercel.svelte";
  import ChromeAssistantUi from "$lib/chrome/ChromeAssistantUi.svelte";
  import ChromeCohere from "$lib/chrome/ChromeCohere.svelte";
  import ChromeXai from "$lib/chrome/ChromeXai.svelte";
  import ChromeMeta from "$lib/chrome/ChromeMeta.svelte";
  ...
  import ChromeInflection from "$lib/chrome/ChromeInflection.svelte";
  import ChromeYou from "$lib/chrome/ChromeYou.svelte";
  import ChromeOpenrouter from "$lib/chrome/ChromeOpenrouter.svelte";
  import ChromeWriter from "$lib/chrome/ChromeWriter.svelte";
  import ChromePoe from "$lib/chrome/ChromePoe.svelte";
  import ChromeFireworks from "$lib/chrome/ChromeFireworks.svelte";
...
{:else if useCustomChrome && activeThemeId === "anthropic"}
  <div data-st-theme={activeThemeId}>
    <ChromeAnthropic
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "openai"}
  <div data-st-theme={activeThemeId}>
    <ChromeOpenai
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "gemini"}
  <div data-st-theme={activeThemeId}>
    <ChromeGemini
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "github"}
  <div data-st-theme={activeThemeId}>
    <ChromeGithub
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "mistral"}
  <div data-st-theme={activeThemeId}>
    <ChromeMistral
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "perplexity"}
  <div data-st-theme={activeThemeId}>
    <ChromePerplexity
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "copilot"}
  <div data-st-theme={activeThemeId}>
    <ChromeCopilot
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "palantir"}
  <div data-st-theme={activeThemeId}>
    <ChromePalantir
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "nous-hermes"}
  <div data-st-theme={activeThemeId}>
    <ChromeNousHermes
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "amazon"}
  <div data-st-theme={activeThemeId}>
    <ChromeAmazon
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "vercel"}
  <div data-st-theme={activeThemeId}>
    <ChromeVercel
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "assistant-ui"}
  <div data-st-theme={activeThemeId}>
    <ChromeAssistantUi
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "cohere"}
  <div data-st-theme={activeThemeId}>
    <ChromeCohere
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "xai"}
  <div data-st-theme={activeThemeId}>
    <ChromeXai
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "meta"}
  <div data-st-theme={activeThemeId}>
    <ChromeMeta
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "together"}
  <div data-st-theme={activeThemeId}>
    <ChromeTogether
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "deepseek"}
  <div data-st-theme={activeThemeId}>
    <ChromeDeepseek
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "databricks"}
  <div data-st-theme={activeThemeId}>
    <ChromeDatabricks
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "inflection"}
  <div data-st-theme={activeThemeId}>
    <ChromeInflection
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "you"}
  <div data-st-theme={activeThemeId}>
    <ChromeYou
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "openrouter"}
  <div data-st-theme={activeThemeId}>
    <ChromeOpenrouter
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "writer"}
  <div data-st-theme={activeThemeId}>
    <ChromeWriter
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "poe"}
  <div data-st-theme={activeThemeId}>
    <ChromePoe
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "fireworks"}
  <div data-st-theme={activeThemeId}>
    <ChromeFireworks
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "saint-gobain"}
  <div data-st-theme={activeThemeId}>
    <ChromeSaintGobain
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "dassault-systemes"}
  <div data-st-theme={activeThemeId}>
...
{:else if useCustomChrome && activeThemeId === "thales"}
  <div data-st-theme={activeThemeId}>
    <ChromeThales
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "safran"}
  <div data-st-theme={activeThemeId}>
    <ChromeSafran
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "capgemini"}
  <div data-st-theme={activeThemeId}>
    <ChromeCapgemini
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "pernod-ricard"}
  <div data-st-theme={activeThemeId}>
    <ChromePernodRicard
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "credit-agricole"}
  <div data-st-theme={activeThemeId}>
...
{:else if useCustomChrome && activeThemeId === "societe-generale"}
  <div data-st-theme={activeThemeId}>
...
{:else if useCustomChrome && activeThemeId === "edenred"}
  <div data-st-theme={activeThemeId}>
    <ChromeEdenred
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "worldline"}
  <div data-st-theme={activeThemeId}>
    <ChromeWorldline
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "vinci"}
  <div data-st-theme={activeThemeId}>
    <ChromeVinci
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "bouygues"}
  <div data-st-theme={activeThemeId}>
    <ChromeBouygues
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "veolia"}
  <div data-st-theme={activeThemeId}>
    <ChromeVeolia
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "publicis"}
  <div data-st-theme={activeThemeId}>
    <ChromePublicis
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "renault"}
  <div data-st-theme={activeThemeId}>
    <ChromeRenault
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "accor"}
  <div data-st-theme={activeThemeId}>
    <ChromeAccor
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "air-liquide"}
  <div data-st-theme={activeThemeId}>
    <ChromeAirLiquide
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "schneider-electric"}
  <div data-st-theme={activeThemeId}>
...
{:else if useCustomChrome && activeThemeId === "engie"}
  <div data-st-theme={activeThemeId}>
    <ChromeEngie
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "edf"}
  <div data-st-theme={activeThemeId}>
    <ChromeEdf
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "loreal"}
  <div data-st-theme={activeThemeId}>
    <ChromeLoreal
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "sanofi"}
  <div data-st-theme={activeThemeId}>
    <ChromeSanofi
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "danone"}
  <div data-st-theme={activeThemeId}>
    <ChromeDanone
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "hermes"}
  <div data-st-theme={activeThemeId}>
    <ChromeHermes
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "kering"}
  <div data-st-theme={activeThemeId}>
    <ChromeKering
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "lvmh"}
  <div data-st-theme={activeThemeId}>
    <ChromeLvmh
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "orange"}
  <div data-st-theme={activeThemeId}>
    <ChromeOrange
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "bnp-paribas"}
  <div data-st-theme={activeThemeId}>
    <ChromeBnpParibas
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "axa"}
  <div data-st-theme={activeThemeId}>
    <ChromeAxa
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
...
{:else if useCustomChrome && activeThemeId === "totalenergies"}
  <div data-st-theme={activeThemeId}>
    <ChromeTotalenergies
      activeThemeId={activeThemeId}
      isThemeOpen={isThemeOpen}
